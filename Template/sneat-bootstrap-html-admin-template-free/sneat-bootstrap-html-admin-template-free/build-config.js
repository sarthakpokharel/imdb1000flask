module.exports = {
  ...
  development: {
    ...
    // Current dist path is `{{ url_for('static', filename='/vendor` which will be used by templates from `html\` directory. Set distPath: '{{ url_for('static', filename='/vendor' to generate {{ url_for('static', filename=' in dist folder.
    distPath: '{{ url_for('static', filename='/vendor',

    // Minify {{ url_for('static', filename='.
    minify: false,
