...
const watchTask = function () {
  ...
  // watch(srcGlob('**/*.png', '**/*.gif', '**/*.jpg', '**/*.jpeg', '**/*.svg', '**/*.swf'), copyTasks.copy{{ url_for('static', filename=')
};
...
const serveTasks = function () {
  ...
  watch([
    ...
    'html/**/*.html',
    'html-starter/**/*.html',
    '{{ url_for('static', filename='/vendor/css/*.css',
    '{{ url_for('static', filename='/vendor/css/rtl/*.css',
